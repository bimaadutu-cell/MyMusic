...
// Helper to get proxied image
const getImg = (url: string) => `https://wsrv.nl/?url=${encodeURIComponent(url)}&w=600&h=600&fit=cover`;
...
export const mockSongs: Song[] = [
  {
    ...
    cover: getImg('https://i.ytimg.com/vi/9qwmR23f3m4/maxresdefault.jpg'),
    duration: '2:46',
    durationSeconds: 166,
    year: '2024',
    genre: 'Pop',
  ...
  },
  {
    ...
    cover: getImg('https://i.ytimg.com/vi/3rI37Cux_Pc/maxresdefault.jpg'),
    duration: '4:12',
    durationSeconds: 252,
    year: '2023',
    genre: 'Pop',
  ...
  },
  {
    ...
    album: 'Sesi Potret',
    cover: getImg('https://i.ytimg.com/vi/S1v7rSNoF9Y/maxresdefault.jpg'),
    duration: '3:45',
    durationSeconds: 225,
    year: '2024',
    genre: 'Indie',
  ...
  },
  {
    ...
    album: 'Purpose',
    cover: getImg('https://i.ytimg.com/vi/fRh_vgS2dFE/maxresdefault.jpg'),
    duration: '3:20',
    durationSeconds: 200,
    year: '2015',
    genre: 'Pop',
  ...
  },
  {
    ...
    artist: 'Justin Bieber',
    album: 'Purpose',
    cover: getImg('https://i.ytimg.com/vi/oyEuk8j8imI/maxresdefault.jpg'),
    duration: '3:53',
    durationSeconds: 233,
    year: '2015',
    genre: 'Pop',
  ...
  },
  {
    ...
    artist: 'for Revenge',
    album: 'Penyangkalan',
    cover: getImg('https://i.ytimg.com/vi/8T9Cq6Lq2m8/maxresdefault.jpg'),
    duration: '4:05',
    durationSeconds: 245,
    year: '2023',
    genre: 'Rock',
  ...
  },
  {
    ...
    artist: 'UNGU',
    album: 'Timeless',
    cover: getImg('https://i.ytimg.com/vi/8kzjT9X3z3o/maxresdefault.jpg'),
    duration: '4:20',
    durationSeconds: 260,
    year: '2022',
    genre: 'Pop Rock',
  ...
  },
  {
    ...
    artist: 'enau & Momo',
    album: 'Sudah Tahu',
    cover: getImg('https://i.ytimg.com/vi/5Ia1i8t9d3E/maxresdefault.jpg'),
    duration: '3:30',
    durationSeconds: 210,
    year: '2023',
    genre: 'Indie',
  ...
  },
  {
    ...
    cover: getImg('https://i.ytimg.com/vi/3q7o1X4r8zY/maxresdefault.jpg'),
    duration: '3:55',
    durationSeconds: 235,
    year: '2023',
    genre: 'Pop',
  ...
  },
  {
    ...
    album: 'Justice',
    cover: getImg('https://i.ytimg.com/vi/tQ0yjYUFKAE/maxresdefault.jpg'),
    duration: '3:18',
    durationSeconds: 198,
    year: '2021',
    genre: 'R&B',
  ...
  },
  {
    ...
    artist: 'Justin Bieber',
    album: 'Justice',
    cover: getImg('https://i.ytimg.com/vi/Fp8msa5uYsc/maxresdefault.jpg'),
    duration: '2:33',
    durationSeconds: 153,
    year: '2021',
    genre: 'Pop',
  ...
  },
  {
    ...
    album: 'F*CK LOVE 3',
    cover: getImg('https://i.ytimg.com/vi/kTJczUoc26U/maxresdefault.jpg'),
    duration: '2:21',
    durationSeconds: 141,
    year: '2021',
    genre: 'Pop',
  ...
  },
  {
    ...
    artist: 'Tiara Andini',
    album: 'Tiara Andini',
    cover: getImg('https://i.ytimg.com/vi/4f4z4f4z4f4/maxresdefault.jpg'),
    duration: '3:45',
    durationSeconds: 225,
    year: '2023',
    genre: 'Pop',
  ...
  },
  {
    ...
    cover: getImg('https://i.ytimg.com/vi/5f5z5f5z5f5/maxresdefault.jpg'),
    duration: '4:10',
    durationSeconds: 250,
    year: '2022',
    genre: 'Pop',
  ...
  },
  {
    ...
    cover: getImg('https://i.ytimg.com/vi/6g6z6g6z6g6/maxresdefault.jpg'),
    duration: '3:30',
    durationSeconds: 210,
    year: '2023',
    genre: 'Pop',
